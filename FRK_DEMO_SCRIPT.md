...
**Voiceover:**
*"Kenya's banks allocate less than 5% of lending to agriculture, despite the sector contributing over 25% of GDP. The Apollo Agriculture securitisation of KES 276 million for 23,839 farmers — with a BBB- rating — proved the model works. But the manual process cannot scale to 5 million farmers. That's why we built Food Roots KE."*
...
**Voiceover:**
*"200 milliseconds later, Grace is approved for KES 18,000 at 9% probability of default. Every decision is logged with a SHA-256 verification hash — auditable by Agusto. But FRK goes further than just lending — it analyses what investment would give Grace the best return on her land."*
...
FRK Investment Advisor — Kiambu, 2.5ha, KES 500,000 budget
══════════════════════════════════════════════════════════
...
{
  "farmer_data": [
    {"id": "frk-001", "max_loan_kes": 18000, "probability_default": 0.09, ...},
    {"id": "frk-004", "max_loan_kes": 45000, "probability_default": 0.05, ...},
    ...
  ]
}
```
...
**Visual:** Docker-compose deploy + "105 tests passing" + FRK logo + satellite Earth image
