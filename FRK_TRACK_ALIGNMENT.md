# FRK — AI for Agriculture Track Alignment

> **Food Roots KE (FRK)** — An AI Agriculture Investment System
>
> **Event:** Mercy Corps AgriFin AI for Agriculture — 2 Days, Nairobi
...
**FRK delivers:** Real-time NASA POWER satellite intelligence for every farmer's field.

| Capability | FRK Implementation | Technical Detail |
|---|---|---|
...
**Why this wins:** Mercy Corps has a formal Space Act Agreement with NASA for "satellite-to-soil" agricultural insights. FRK is the only entry using the same NASA POWER data that Mercy Corps champions. Not simulations. Not averages. Live data from space.

---

## Track 2: Last-Mile Service Delivery (SMS, WhatsApp, Extension Systems)

**FRK delivers:** Multi-channel farmer interface accessible on the most basic phones.
...
**Why this wins:** FRK serves the farmer who owns a basic phone with M-Pesa, not the farmer with a smartphone. SMS/USSD + Swahili + offline mode = real last-mile accessibility.

---

## Track 3: Financial Inclusion (Credit, Insurance, Input Access)

**FRK delivers:** Graph-native credit scoring with alternative data, Cardano escrow settlement, and automated securitisation.
...
| **Verified by Apollo Agriculture** | Apollo KES 276M, 23,839 farmers, BBB- rating | FRK automates the manual underwriting process Apollo proved viable. |
...
**Why this wins:** FRK targets the 54% of farmers who cite high interest rates as the primary barrier (CBK). At 18% APR target vs 80-400% informal lenders, the savings are life-changing. Cardano x402 removes the FX premium that adds 5-10% to every USD-denominated agricultural loan.

---

## Track 4: Data and Decision Support (PRIMARY TRACK)

**FRK delivers:** The only end-to-end pipeline from NASA satellite data to ranked autonomous investment recommendations.
...
**Why this is the primary track:** No other entry transforms raw satellite data into ranked investment decisions. The demo shows 3 investment opportunities (1300%, 302%, 39% ROI) computed in 3 seconds from real NASA data. This is the most sophisticated data-to-decision pipeline in the competition.

---

## Track 5: Pest, Disease & Crop Management

**FRK delivers:** AI-powered crop suitability, seed quality, and post-harvest loss reduction.
...
**Why this wins:** Most "pest and disease" entries are reactive — identify a problem after it appears. FRK is proactive — it prevents crop failure by recommending the right seed for the right field before planting.

---

## Summary: FRK by Evaluation Criterion

| Criterion | FRK Score | Why |
|---|---|---|
...
| **Demo Script** | `FRK_DEMO_SCRIPT.md` — 10 scenes, 4 minutes |
| **Judging Rubric** | `FRK_JUDGING_RUBRIC.md` — criterion-by-criterion alignment |
| **Track Alignment** | `FRK_TRACK_ALIGNMENT.md` — this document |
| **Vision Statement** | `FRK_VISION.md` — "Systems, not apps" |
